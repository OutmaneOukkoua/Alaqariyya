...
// // // //   let sql = `
// // // //     SELECT p.property_id, p.${titleColumn} as title, p.price, p.${locationColumn} as location, p.bedrooms, p.bathrooms, p.salon, p.area, p.type, p.available, p.floors, p.availability_date, pi.image_url, p.${descriptionColumn} as description
// // // //     FROM properties p
// // // //     LEFT JOIN (
// // // //       SELECT property_id, MIN(image_url) as image_url
// // // //       FROM property_images
...
// // // //     console.log('Fetched properties:', result); // Log the fetched properties to verify data
...
// //   console.log('SQL Query:', sql); // Log the SQL query to verify
// //   console.log('Parameters:', params); // Log the parameters to verify
...
//       salon: req.body.salon,
//       bathrooms: req.body.bathrooms,
//       kitchen: req.body.kitchen, // Add this line
//       area: req.body.area,
//       type: req.body.type,
//       available: req.body.type === 'rent' ? true : req.body.available,
//       floors: req.body.floors,
