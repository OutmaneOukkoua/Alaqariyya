...
// // //               <input type="text" name="location_ar" placeholder="location_ar" value={selectedProperty.location_ar} onChange={handleInputChange} required />
...
// //     try {
// //       const response = await axios.get(`${API_URL}/properties?page=${page}`);
// //       console.log('Fetched properties:', response.data.properties); // Log the fetched properties to verify data
// //       setProperties(response.data.properties || []);
// //       setTotalPages(response.data.totalPages);
// //     } catch (error) {
// //       console.error('Error fetching properties:', error);
...
//             ) : (
//               <tr>
//                 <td colSpan="13">No properties found</td> {/* Update colspan */}
//               </tr>
//             )}
//           </tbody>
//         </table>
...
//               <input type="number" name="salon" placeholder="Salon" value={selectedProperty.salon} onChange={handleInputChange} required />
//               <input type="number" name="bathrooms" placeholder="Bathrooms" value={selectedProperty.bathrooms} onChange={handleInputChange} required />
//               <input type="number" name="kitchen" placeholder="Kitchen" value={selectedProperty.kitchen} onChange={handleInputChange} required /> {/* Add kitchen field */}
//               {selectedProperty.type === 'rent' && (
//                 <input
//                   type="date"
//                   name="availability_date"
